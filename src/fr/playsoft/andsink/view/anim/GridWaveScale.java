...
public class GridWaveScale extends BaseActivity {

	@Override
	public void setupMainLayoutId() {
		ACTIVITY_LAYOUT = R.layout.view_anim_06_gridwave;
	}
	...
	public void setupOthersInMainLayout() {
		GridView grid = (GridView) findViewById(R.id.anim_06_grid);
        grid.setAdapter(new GridAnimAdapter(GridWaveScale.this));
